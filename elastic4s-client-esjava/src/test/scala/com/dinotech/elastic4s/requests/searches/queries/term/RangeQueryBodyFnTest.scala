package com.dinotech.elastic4s.requests.searches.queries.term

import com.dinotech.elastic4s.http.search.queries.term.RangeQueryBodyFn
import com.dinotech.elastic4s.searches.queries.{RangeQuery, RangeRelation}
